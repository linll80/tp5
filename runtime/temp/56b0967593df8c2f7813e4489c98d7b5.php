<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/nav/list.htm";i:1587991527;s:77:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/common/top.htm";i:1587991527;s:78:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/common/left.htm";i:1587991527;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($navRes) || $navRes instanceof \think\Collection || $navRes instanceof \think\Paginator): $i = 0; $__LIST__ = $navRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo $nav['nav_url']; ?>" target="_blank"><?php echo $nav['nav_url']; ?></a></td>
                                    <td align="center">
                                        <?php if($nav['pos'] == 'top'): ?>
                                            顶部
                                    ...
                                    <td align="center">
                                        <a href="<?php echo url('edit',array('id'=>$nav['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$nav['id'])); ?>')" class="btn btn-danger btn-sm shiny">
                            ...
                            <tr>
                               <td colspan="7" style="padding-left:10.5%;"><input class="btn btn-sm btn-azure btn-addon" type="submit" value="排序"></td> 
                            </tr>
                        </tbody>
                    </table>
                </form>
