<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/brand/edit.htm";i:1587991527;s:77:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/common/top.htm";i:1587991527;s:78:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/common/left.htm";i:1587991527;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <img src="__uploads__/<?php echo $brands['brand_img']; ?>" height="30">
                                <?php else: ?>
                                暂无图片
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="status" value="1" class="colored-blue" <?php if($brands['status'] == 1): ?> checked="checked" <?php endif; ?> type="radio">
                                        <span class="text">显示</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input name="status" value="0" <?php if($brands['status'] == 0): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
