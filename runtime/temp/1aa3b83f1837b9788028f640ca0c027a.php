<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/brand/list.htm";i:1587991527;s:77:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/common/top.htm";i:1587991527;s:78:"/usr/local/apache2/htdocs/tp5/public/../application/admin/view/common/left.htm";i:1587991527;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($brandRes) || $brandRes instanceof \think\Collection || $brandRes instanceof \think\Paginator): $i = 0; $__LIST__ = $brandRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td><?php echo cut_str($brand['brand_description'],10); ?></td>
                                    <td align="center">
